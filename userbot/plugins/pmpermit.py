...
MAFIAPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/5596812541665b58045b7.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
h1m4n5hu0p = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "**ANDA TELAH MELANGGAR INBOX MASTER SAYA** \n INI ILEGAL DAN DIANGGAP SEBAGAI KEJAHATAN"
)
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Mafia User"
USER_BOT_WARN_ZERO = "**Anda mengirim spam ke kotak masuk tuanku yang manis, selanjutnya Anda telah diblokir oleh BUZZ Guard tuanku.**\n_Sekarang GTFO, saya sibuk_"
USER_BOT_NO_WARN = (
    "Hello, Ini adalah **BUZZ Ultra Private Security Protocol⚠️**.\n"
    f"Ini adalah Pesan Tuanku {DEFAULTUSER}\n"
    f"\n**{h1m4n5hu0p}**\n\n"
    "Untuk memulai percakapan yang valid\n🔱Daftarkan Permintaan Anda!🔱\nKirim `/start` Untuk Mendaftarkan Permintaan Anda\nSemoga Anda mendapat balasan🔥"
)
