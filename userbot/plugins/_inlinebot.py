...
mafia_help_pic = Config.HELP_PIC or "https://telegra.ph/file/5599bdacfbd38a8790a99.png"
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        if event.query.user_id == bot.uid and query == "@Kisahkitaakukaudanmereka":
            rev_text = query[::-1]
            ...
            result = builder.article(
                ...
                text=f"""**Hey![🤗]({mafia_help_pic}) This is [MafiaBot.](https://t.me/Kisahkitaakukaudanmereka)\nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/Kisahkitaakukaudanmereka"),
                        custom.Button.url(
                            "⚡ GROUP ⚡", "https://t.me/+kmLDgM_WfyM4NDU1"
                        ),
                    ],
                    [
                        custom.Button.url(
                            "✨ OWNER ✨", "https://t.me/psycho_syridwan"),
                        custom.Button.url
                    (
                            "🔰 MOD 1 🔰", "https://t.me/CitraAyuWinieF"
                    )
                    (
                            "🔰 MOD 2 🔰", "https://t.me/xnafrlzy"
                    )
                    ],
                ],
                link_preview=True,
    ...
    async def page(event):
        ...
        await event.edit(
            f"**BUZZ MafiaBot[⚡🔥]({mafia_help_pic})[.](https://t.me/Kisahkitaakukaudanmereka) __Working...__\n\n**Number of modules installed :** `{len(CMD_HELP)}`\n**page:** {page + 1}/{veriler[0]}",
            buttons=veriler[1],
            link_preview=True,
        )
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            await event.edit(f"⚜️MafiaBot Menu Provider Is now Closed[⚜️]({mafia_help_pic})\n\n         **[© MafiaBot ™](t.me/Kisahkitaakukaudanmereka)**[⚡🔥]({mafia_help_pic})", 5, link_preview=True)
        else:
